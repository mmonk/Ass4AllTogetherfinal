...
namespace Ass4AllTogether.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,FirstName,LastName,Address,CourseID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,FirstName,LastName,Address,CourseID")] Student student)
        {
            if (ModelState.IsValid)
            {
